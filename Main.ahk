...
global GAME_PASS_IDS := [1046637936, 1222540123, 1222262383, 1222306189, 1220930414]
EnvGet, LOCAL_COMPUTER_NAME, ComputerName
global WEB_APP_URL := "https://script.google.com/macros/s/AKfycbz2eHdQox_6LtmpD44KGul28CP4TUmanSpnjhvVtd2dAJOWFqdVmh_S4wLn119gCLlG9Q/exec"
global webhookURL
...
for _, gpId in GAME_PASS_IDS {
    ...
    if (!hasPass) {
        MsgBox, 64, Sheet Check, Cracked by oto lol.
        hasPass := true
    }
    EnvGet, compName, ComputerName
...
Gui, Add, Picture, x240 y180 w48 h48, % mainDir "Images\\oto.png"
Gui, Font, s10 cWhite Bold, Segoe UI
Gui, Add, Text, x300 y180 w180 h24, oto
Gui, Font, s8 cWhite, Segoe UI
Gui, Add, Text, x300 y206 w180 h40, cracked the macro (sorry).
Gui, Show, w520 h425, [CRACKED BY OTO] Virage Premium GAG Macro [BIZZY BEES/FRIENDSHIP UPDATE]
Return
